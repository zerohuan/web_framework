					...
					<div class="sidebar-nav-fixed">
						...
						<ul class="menu" id="accordion-menu-js">
							<li class="current">
								...
								<ul>
									<li>
										<a href="main_t.jsp" class="expanded">Dashboard</a>
									</li>
									<li>
							...
							<ul>
								<li>
									...
									<a href="javascript:void(0)" title="">
										<img src="<c:url value="/resources/img/start-icons/add-user.png" />" alt="" />
								...
								<li>
									<label>246 </label>
									<a href="javascript:void(0)" title="">
										<img src="<c:url value="/resources/img/start-icons/orders.png" />" alt="" />
										<span>View Orders</span>
									</a>
								</li>
								<li>
									<a href="javascript:void(0)" title="">
										<img src="<c:url value="/resources/img/start-icons/mass.png" />" alt="" />
										<span>Broadcast</span>
									</a>
								</li>
								<li>
									<label>new</label>
									<a href="javascript:void(0)" title="">
										<img src="<c:url value="/resources/img/start-icons/stats.png" />" alt="" />
								...
								<li>
									<label>657</label>
									<a href="javascript:void(0)" title="">
										<img src="<c:url value="/resources/img/start-icons/pending-message.png" />" alt="" />
										<span>Comments</span>
									</a>
								</li>
								<li>
									<a href="javascript:void(0)" title="">
										<img src="<c:url value="/resources/img/start-icons/upgrade.png" />" alt="" />
									    ...
									    <div>
									        ...
									        <div class="inner-spacer chat-widget widget-content-padding">
									              ...
									              <div class="tab-pane fade in active" id="user1">
									              	...
									              	<div class="chat-messages">
														...
														<p id="message-id-1" class="message-box">
															<img src="<c:url value="/resources/img/avatar/avatar_1.jpg" />" alt="" />
															<span class="message">
									              ...
									              <div class="tab-pane fade" id="user2">
									              	...
									              	<div class="chat-messages">
														...
														<p id="message-id-4" class="message-box">
															<img src="<c:url value="/resources/img/avatar/avatar_2.jpg" />" alt="" />
															<span class="message">
																<strong>David Simpson</strong>
																<span class="message-time">14:23pm, 4th Jan 2013</span>
																<span class="message-text">Hi ${user.username}, Yes you have uploaded it and its currently in que. I will have a look at it and send you an email shortly.</span>
															</span>
														</p>
														<!-- end message-id-1 -->
									            ...
									            <div class="row-fluid chat-box">
													...
													<div class="row-fluid">
		                                                <div class="span6 type-effect" style="display:none"><img src="<c:url value="/resources/img/loaders/misc/16-2.gif" />" alt="" /> ${user.username} is typing...</div>
