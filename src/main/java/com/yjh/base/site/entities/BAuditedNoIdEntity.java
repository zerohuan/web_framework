 ...
 */
@MappedSuperclass
public abstract class BAuditedNoIdEntity extends BVersionedNoIdEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BAuditedNoIdEntity)) return false;
        if (!super.equals(o)) return false;

        BAuditedNoIdEntity that = (BAuditedNoIdEntity) o;
